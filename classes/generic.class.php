...
$from = "Webmaster <webmaster@typebeautiful.ly>"; //you need to set this
$subject = $subj;
$body = $msg;

$host = "smtp.mailgun.org";  //you need to set this
$port = "587"; //you need to set this
$username = "postmaster@typebeautiful.ly";  //you need to set this
$password = "80723f78fwd4";  //you need to set this
...
if (PEAR::isError($mail)) {
  ...
  return true;
	...
	public function definePaths() {
		...
		if (!defined('phplogin_version'))       define( 'phplogin_version',    3.20);
